...
public class BoardController {
	...
	@GetMapping("/page")
	public String page(@RequestParam("no") int no, @RequestParam("pno") int pno, @RequestParam("cno") int cno,
	...
	// 댓글 읽어오기
	@GetMapping(value = "/getReply/{pno}", produces = { MediaType.APPLICATION_XML_VALUE,
	...
	// 댓글 등록
	@PostMapping(value = "/riply/new", consumes = "application/json", produces = { MediaType.TEXT_PLAIN_VALUE })
	...
	// 대댓글 등록
	@PostMapping(value = "/riplies/new", consumes = "application/json", produces = { MediaType.TEXT_PLAIN_VALUE })
	...
	// 댓글 삭제
	@PostMapping(value = "/riplies/delete", consumes = "application/json", produces = { MediaType.TEXT_PLAIN_VALUE })
	...
	public String makeBoard(RedirectAttributes rttr, BoardVO bVo, Principal principal) {
		...
		// return
		// "redirect:/board/page?no="+where_board+"&pno="+pno+"&cno="+bpVo.getCno();
	}

	// search
	// 댓글 읽어오기
	@GetMapping(value = "/getSearchBoard/{currentVal}", produces = { MediaType.APPLICATION_XML_VALUE,
			MediaType.APPLICATION_JSON_UTF8_VALUE })
	...
	@PostMapping(value = "/registerfiles", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	@ResponseBody
